...
# encoding: utf-8
Product.delete_all
product = Product.create(title: 'Programming Ruby 3.3 (9th edition)', description:
  %(<p>
...
product = Product.create(title: 'Rails Scales bro!',
  description:
    %(<p>
...
product = Product.create(title: 'Modern Front-End Development for Rails, Second Edition',
  description:
    %(<p>
      <em>Hotwire, Stimulus, Turbo, and Svelte</em>
